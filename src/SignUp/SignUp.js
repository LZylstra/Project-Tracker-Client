...
class SignUp extends Component {
	...
	validateInput = () => {
		return !!this.validateCompany() || !!this.validateConfirmPassword() || !!this.validateEmail() || !!this.validateFullName() || !!this.validatePassword()
	}
	...
	render(){
		...
		const confirmPasswordVal = this.inputValidation(this.validateConfirmPassword())
		...
		return (
			<div className="signup">
				<form id="signup-form" onSubmit={this.handleSubmit} >
					...
					{
						fullNameValidation && <p className='error'>{this.validateFullName()}</p>
					}
					<label htmlFor="full-name-input" className="hidden-label">Full Name</label>
					<input type="text" placeholder="Full Name" id="full-name-input" className="inputs" onChange={this.handleFullNameChange} required/>
					{
						passwordValidation&& <p className='error'>{this.validatePassword()}</p>
					}
					...
					{
						confirmPasswordVal && <p className='error'>{this.validateConfirmPassword()}</p>
					}
					<label htmlFor="confirm-password-input" className="hidden-label">Confirm Password</label>
					<input type="password" placeholder="Confirm Password" id="confirm-password-input" className="inputs" onChange={this.handleConfirmPasswordChange} required/>
					{
						companyValidation && <p className='error'>{this.validateCompany()}</p>
					}
					<label htmlFor="company-input" className="hidden-label">Company</label>
					<input type="text" placeholder="Company" id="company-input" className="inputs" onChange={this.handleCompanyChange} required/>
